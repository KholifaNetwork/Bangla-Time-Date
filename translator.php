...
if(isset($bddp_options['trans_cal']) == "1") {
...
/* translators: Calendar caption: 1: month name, 2: 4-digit year */
	...
	for ( $wdcount=0; $wdcount<=6; $wdcount++ ) { $myweek[] = $wp_locale->get_weekday(($wdcount+$week_begins)%7); }
